...
public class RestControlComment {
	...
	@ResponseBody
	public void addParentComment(@RequestBody Comment comment, @PathVariable("subjectId") int subjectId,
	...
	@ResponseBody
	public void addChildComment(@RequestBody Comment comment, @PathVariable("subjectId") int subjectId,
			@PathVariable("userId") int userId, @PathVariable("parentId") int parentId) {
